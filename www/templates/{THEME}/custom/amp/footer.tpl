...
<footer class="ampstart-footer flex flex-column items-center px3 ">
    ...
    <nav class="ampstart-footer-nav">
        <ul class="list-reset flex flex-wrap mb3">
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://tcse-cms.com/about.html">О компании</a></li>
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://tcse-cms.com/contacts.html">Контакты</a></li>
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://tcse-cms.com/portfolio/">Портфолио</a></li>
        </ul>
    </nav>
    <small>
        © {site-name}, 2020<br>
